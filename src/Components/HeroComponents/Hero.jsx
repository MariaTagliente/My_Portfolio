...
export default function Hero(){
    return(
        <>
          <section className="min-h-screen flex items-start relative overflow-hidden hero-gradient py-16">
            ...
            <div className="container mx-auto px-6 items-center relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-0">
                {/* COLONNA SX TESTO */}
                <div className="text-center md:text-left">
                    ...
                    <p className="mt-4 text-gray-300 max-w-md mx-auto md:mx-0 leading-relaxed text-sm md:text-base">
                        Trasformo idee in applicazioni web moderne e responsive, con focus su React e tecnologie full stack.
                    </p>
